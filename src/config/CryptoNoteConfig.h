...
// Copyright (c) 2018, The EuGoldCoin Developers
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1416884;
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001ffffffffffff0f029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd08807121018f83290597f8a187d7db0bdf86a37df5f2cd27c6be6bda98fe0a8b8883fd3c55";
...
const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "valepoolstate.bin";
const char     P2P_NET_DATA_FILENAME[]                       = "p2pstatevale.bin";
const char     MINER_CONFIG_FILE_NAME[]                      = "valeminer_conf.json";
} // parameters
...
const int      P2P_DEFAULT_PORT                              =  36869;
const int      RPC_DEFAULT_PORT                              =  36870;
...
const char     LATEST_VERSION_URL[]                          = "http://latest.eugoldcoin.lol";
const std::string LICENSE_URL                                = "https://github.com/forwelldj/eugoldcoinn/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x4c, 0x55, 0x45, 0x55, 0x47, 0x4f, 0x4c, 0x44, 0x43, 0x4f, 0x49, 0x4e, 0x43, 0x41, 0x53, 0x54  }
};

const char* const SEED_NODES[] = {
  "207.180.223.131:36869", //Jack Passou Aqui e deixou avisado que consegiu L.S.
  "207.180.242.94:36869", // Se eu conseguir vai ser foda, vou ajudar e doar para quem precisa!
};
} // CryptoNote
