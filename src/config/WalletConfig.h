...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "EUGC";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "EUGC";
    ...
    const std::string walletName = "goldwallet";
    ...
    const std::string contactLink = "http://chat.goldcoin.it";
